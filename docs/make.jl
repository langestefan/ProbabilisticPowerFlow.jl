...
DocMeta.setdocmeta!(ProbabilisticPowerFlow, :DocTestSetup, :(using ProbabilisticPowerFlow); recursive = true)
...
makedocs(;
    ...
    format = Documenter.HTML(; canonical = "https://langestefan.github.io/ProbabilisticPowerFlow.jl"),
    pages = list_pages(),
)
